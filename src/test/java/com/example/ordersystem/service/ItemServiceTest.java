...
@SqlGroup({
        @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD, statements="ALTER TABLE items ALTER SEQUENCE id RESTART WITH 1"),
        @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, statements="ALTER TABLE items ALTER SEQUENCE id RESTART WITH 1")
})
@SpringBootTest
