...
@SqlGroup({
        @Sql(executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD, statements="ALTER TABLE items ALTER SEQUENCE item_sequence RESTART WITH 1"),
        @Sql(executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD, statements="ALTER TABLE items ALTER SEQUENCE item_sequence RESTART WITH 1")
})
@SpringBootTest
